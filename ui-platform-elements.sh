...
repo_url="https://github.com/VinayakaD-RS/ui-platform-elements.git"

# Clone the repository
git clone $repo_url

# Change directory to the repository
cd ui-platform-elements
...
# Add a remote branch
git remote add upstream https://github.com/riversandtechnologies/ui-platform-elements
